...
export const QuestionsCategoryOptions = {
	"ESE124 Related": "ESE124 Related",
	"ETC": "ETC",
} as const
export type QuestionsCategoryOptions = typeof QuestionsCategoryOptions[keyof typeof QuestionsCategoryOptions]
export type QuestionsRecord = {
	category?: QuestionsCategoryOptions
	content: string
	created: IsoAutoDateString
	id: string
	title: string
